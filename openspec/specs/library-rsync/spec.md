# library-rsync Specification

## Purpose

Synchronize skill content across SSH hosts while preserving home-relative locations, Git revisions, independently edited content, and host-local user selections.
